...
if(isset($_REQUEST["excel"]))
    {
        echo "<script>location.href='excel-report/mysubject_report.php?exid=".$_REQUEST['exid']."&subid=".$_REQUEST['subid']."';</script>";
    }
				...
				<form method="post" id="form1" action="">
					...
					<div class="input-group" style="margin:-35px 0px 20px 354px;">
						...
						<select name="subid" class="form-control" style="width:200px;">
                            ...
                            if($flag!=0)
                            {   $r=mysql_query("select * from subject_tbl where sem%2=0 AND fid=".$_SESSION["fid"]." AND sname!='Practical'");
							     while($r1=mysql_fetch_object($r)){?>
