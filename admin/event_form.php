                    ...
                    if($err == "")
					 {
                        ...
                        $col=array('name','edate','photo','description','enabled');
                        $val=array($_REQUEST['name'], $_REQUEST['edate'], $img_path1, $_REQUEST['description'],$_REQUEST['enabled']);
			...
			{  $im=0;
              ...
              else
              {
                  $img_path1=$_REQUEST["himg"];
					...
					if($err == "")
					{
						$col=array($pk,'name','edate','photo','description','enabled');
						$val=array(null, $_REQUEST['name'], $_REQUEST['edate'], $img_path1, $_REQUEST['description'],'Y');
...
{
    echo "<script>$(document).ready(function(){pops('Event Added Successfully!','success');});</script>";
}
			...
			<div class="block" style="border: none;box-shadow: none;margin:50px 0">
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" value="<?= $name; ?>" id="example-username" name="name" class="form-control" placeholder="Event Name" data-bvalidator="required">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon">Event Date</span>
							<input type="text" id="example-datepicker" name="edate" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="YYYY-MM-DD" value="<?= $edate; ?>" data-bvalidator="required">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
