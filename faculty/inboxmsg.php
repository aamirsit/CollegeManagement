...
<div class="ms-message-content">
    <h3>Attached File :</h3>
    <b><?=$r->attach."   ";?></b><?php if($r->attach==""){echo "No Attached File";}else{?><a href="download.php?df=<?=$r->attach?>" id="<?= $r->attach?>" data-toggle="tooltip" title="Download">Download File</a><?php }?>
</div>
</div>
<script>
