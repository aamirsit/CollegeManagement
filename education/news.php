                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="wm-courses wm-courses-popular wm-courses-mediumsec">
                                <ul class="row">
                                    <?php $r=mysql_query("Select * From news_tbl where enabled='Y' AND ndate >= CAST(CURRENT_TIMESTAMP AS DATE) order by ndate DESC");
                                while($r1=mysql_fetch_object($r)){
                                        $img=explode(",", $r1->photo);
                                    ?>
                                    <li class="col-md-12">
                                        <div class="wm-courses-popular-wrap" style="max-height: 242px;min-height: 242px;">
                                            <figure style="max-height: 242px;overflow: hidden;"> <a href="news-detail.php?eid=<?=$r1->nid?>"><img id="eventimg" style="height: 242px;" src="../faculty/uploadimage/<?= $img[0]?>" alt=""><span class="wm-popular-hover"> <small>More Detail</small> </span> </a>
                                            </figure>
                                            <div class="wm-popular-courses-text">
                                                ...
                                                <ul style="position: relative;top: 90%;">
                                                    <li><a href="#" class="wm-color"><i class="wmicon-time2"></i> <?= time_elapsed_string($r1->ndate)?></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
