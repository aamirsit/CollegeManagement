...
{
            echo "<script>location.href='../faculty/excel-report/atten_per_list_report.php?year=".$_REQUEST['year']."&sem=".$_REQUEST['sem']."';</script>";
}
				...
				<div class="form-group" style="margin-left:-50px;width:250px;">
					<div class="input-group">
							...
							<select class="form-control" name="year">
							    <?php 
                                    $y=mysql_query("select * from year_tbl order by year");
                ...
                <div class="form-group" style="margin:-50px 0 20px 250px;">
				    <div class="input-group">
							...
							<select class="form-control" name="sem" style="width:100px;">
							    <?php 
                                    $y=mysql_query("select * from student_sem_tbl group by sem order by sem");
                                    while($y1=mysql_fetch_object($y))
                                    {?>
