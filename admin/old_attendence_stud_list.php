...
$pk="attid";
$nm="Particular Student old"; 
$name="Particular Student old";
$n=0;
if(isset($_REQUEST["excel"]))
    {
            echo "<script>location.href='../faculty/excel-report/attendance_studlist_report.php?year=".$_REQUEST['year']."&studid=".$_REQUEST['studid']."&sem=".$_REQUEST['sem']."';</script>";
    }
                                         ...
                                         while($r1=mysql_fetch_object($r))
                                         {
                                            ...
                                            {?>
                                               ...
                                               <td class="text-center"><?= $r1->attenddate?></td>
                                                <td class="text-center" style="text-decoration:<?=$dec?>;background-color:<?=$col?>;color:<?=$col1?>;"><?= $pre?></td>
                                               <?php
                                         }
                                     }
