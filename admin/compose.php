				    ...
				    if(!empty($_FILES["file1"]["name"]))
                    {
						...
						if($myextension == ".jpg" || $myextension == ".jpeg" || $myextension == ".gif" || $myextension == ".bmp" || $myextension == ".png" || $myextension == ".pdf" || $myextension == ".doc" || $myextension == ".docx" || $myextension == ".html" || $myextension == ".htm" || $myextension == ".txt" || $myextension == ".psd" || $myextension == ".xls" || $myextension == ".ppt" || $myextension == ".php" || $myextension == ".js" || $myextension == ".css" || $myextension == ".aspx" || $myextension == ".exe" || $myextension == ".mp3" || $myextension == ".mp4" || $myextension == ".mpeg" || $myextension == ".mkv" || $myextension == ".avi") {
								if ($_FILES["file1"]["error"] > 0) {
									...
									{
										if($_REQUEST["himg"]!= "") {
											unlink("../facultyuploaddocs/".$_REQUEST["himg"]);
										}
									move_uploaded_file($_FILES["file1"]["tmp_name"], "../faculty/uploaddocs/" . $fileName);
									$img_path1=$fileName;
								}
							}
						else
              ...
              else
              {
                  $img_path1=$_REQUEST["himg"];
					 ...
					 if($err == "")
					{
                        ...
                        $val=array(null, $_SESSION["lid"], $_REQUEST['subject'], $_REQUEST['description'],$img_path1,date('Y-m-d h:i:s'),0,0);
				    ...
				    if(!empty($_FILES["file1"]["name"]))
                    {
						...
						if($myextension == ".jpg" || $myextension == ".jpeg" || $myextension == ".gif" || $myextension == ".bmp" || $myextension == ".png" || $myextension == ".pdf" || $myextension == ".doc" || $myextension == ".docx" || $myextension == ".html" || $myextension == ".htm" || $myextension == ".txt" || $myextension == ".psd" || $myextension == ".xls" || $myextension == ".ppt" || $myextension == ".php" || $myextension == ".js" || $myextension == ".css" || $myextension == ".aspx" || $myextension == ".exe" || $myextension == ".mp3" || $myextension == ".mp4" || $myextension == ".mpeg" || $myextension == ".mkv" || $myextension == ".avi") {
								if ($_FILES["file1"]["error"] > 0) {
									...
									{
										if($_REQUEST["himg"]!= "") {
											unlink("../faculty/uploaddocs/".$_REQUEST["himg"]);
										}
									move_uploaded_file($_FILES["file1"]["tmp_name"], "../faculty/uploaddocs/" . $fileName);
									$img_path1=$fileName;
								}
              ...
              else
              {
                  $img_path1=$_REQUEST["himg"];
					 ...
					 if($err == "")
					{
                        ...
                        $col=array($pk,'mailfrom','subject','description','attach','maildate','isdraft','isdelete');
                        $val=array(null, $_SESSION["lid"], $_REQUEST['subject'], $_REQUEST['description'],$img_path1,date('Y-m-d h:i:s'),1,0);
                        $db->insert($table, $col, $val);
                        echo "<script>location.href='message_center.php?sv'</script>";
				    } 
                    else
				...
				<form method="post" enctype="multipart/form-data" id="form1">
                    ...
                    <div class="form-group">
						<div class="input-group">
							  <b style="font-size:15px;margin-left:-10px;">&nbsp;&nbsp;&nbsp;From :&nbsp;&nbsp;<?php $f=mysql_fetch_object(mysql_query("select * from faculty_tbl where fid=".$_SESSION["lid"])); echo $f->fname." ".$f->lname;?></b>
						</div>
					</div>
					<div class="form-group" >
						<div class="input-group">
                            <select  id="example-chosen-multiple" name="fac[]" class="select-chosen" data-placeholder="Send To" style="width:550px;" multiple>
                                <?php  
                                    $r=mysql_query("select * from faculty_tbl where fid!=".$_SESSION["lid"]);
                    ...
                    <div class="form-group">
						<div class="input-group">
							<textarea style="width:550px;" id="compose-message" name="description" rows="4" class="form-control textarea-editor" data-bvalidator="required"  placeholder="Compose Message"><?= $description?></textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
