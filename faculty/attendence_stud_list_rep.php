...
if(isset($_REQUEST["excel"]))
    {
            echo "<script>location.href='excel-report/attendance_studlist_report.php?studid=".$_REQUEST['studid']."&sem=".$_REQUEST['sem']."';</script>";
    }
...
?>
    <li class=""><a href="attendence_form.php"><i class="icon-reply"></i><b>&nbsp;&nbsp;&nbsp;&nbsp;Back</b></a></li><?php }else{?>
