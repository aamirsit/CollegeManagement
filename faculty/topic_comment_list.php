...
<?php 
    if(isset($_REQUEST["csbtn"]))
    {
        if(isset($_REQUEST["gdtid"]))
        {
            ...
            $val=array(null,$_SESSION["fid"],$_REQUEST["gdtid"],$_REQUEST["comment"],date('Y-m-d h:i:s A'));
        ...
        <div class="col-sm-12" style="margin-top:20px;">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color:orange;" id="accordion">
                    <span class="glyphicon glyphicon-comment" style="color:white;font-family:'Josefin Sans';font-size:1.5em;">
                       <?php 
                            if(isset($_REQUEST['gdtid'])){
                    ...
                    <div class="btn-group pull-right">
                        <a type="button" style="background-color:transparent;border:none;outline:0;" class="btn btn-primary btn-xs" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
